...
<https://github.com/awaka0>

Чтобы оформить ссылкой часть текста, используется такой синтаксис: [текст](ссылка). Можно сделать всплывающую подсказку при наведении курсора. Для этого в круглых скобках после ссылки нужно поставить пробел и написать текст подсказки в кавычках.

[awaka0](https://github.com/awaka0) без подсказки

[awaka0](https://github.com/awaka0 "Всплывающая подсказка") с подсказкой
...
[1]: https://github.com/awaka0 "Всплывающая подсказка"
[code]: https://github.com/awaka0/shporgalka322/blob/main/magsf.md "обязательно прочитай!!"
...
Клонирует репозиторий с GitHub на ваш компьютер:
```bash
git clone https://github.com/имя-пользователя/имя-репозитория.git
```
![](123/6.jpg)

После этого у вас будет локальная копия репозитория, уже привязанная к удалённому.

### 2. Просмотр подключённых удалённых репозиториев
...
Добавляет новый удалённый репозиторий (если вы хотите, например, подключить второй origin):
```bash
git remote add origin https://github.com/имя-пользователя/имя-репозитория.git
```
### 4. Получение изменений с GitHub (pull/fetch)
Fetch — просто забирает изменения с GitHub, но не сливает их с вашей веткой:
```bash
git fetch origin
```
Pull — забирает и автоматически сливает изменения в текущую ветку:
```bash
git pull origin main
```
(где main — ветка, которую вы хотите обновить)

### 5. Отправка изменений на GitHub (push)
...
Если ветка новая и ещё не существует на GitHub:
```bash
git push -u origin имя-ветки
```
Параметр -u устанавливает отслеживание между локальной и удалённой веткой.

### 6. Удаление удалённого репозитория
Если хотите удалить привязку к удалённому репозиторию:
```bash
git remote remove origin
```
### 7. Изменение URL удалённого репозитория
Например, если вы сменили название репозитория или перешли с HTTPS на SSH:
```bash
